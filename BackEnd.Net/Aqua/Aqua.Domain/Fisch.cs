...
public class Fisch
{
    ...
    [BsonElement("wissenschaftlich")]
    public string Wissenschaftlich { get; set; }
    
    [BsonElement("herkunft")]
    ...
    [BsonElement("temperatur")]
    public Bereich Temperatur { get; set; }
    
    [BsonElement("schwimmzone")]
    ...
    [BsonIgnore]
    public string AquaType { get; private set; } = nameof(Fisch).ToLower();
}